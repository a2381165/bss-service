...
class ChannelUser(db.Model):
    ...
    def __init__(self, user_name, user_salt, user_password, user_phone, user_email, avatar, nick_name, reg_time, reg_ip,
                 is_check_phone, is_check_email, access_token, refresh_token, reg_type, is_lock):
        '''Constructor'''
...
clinetHead = ['id', 'userName', 'userSalt', 'userPassword', 'userPhone', 'userEmail', 'avatar', 'nickName', 'regTime',
              'regIp', 'isCheckPhone', 'isCheckEmail', 'accessToken', 'refreshToken', 'regType', 'isLock']
ChannelUserChangeDic = {
    "id": "id",
    "userName": "user_name",
    "userSalt": "user_salt",
...
intList = ['id', 'isCheckPhone', 'isCheckEmail', 'regType', 'isLock']
