...
class OrderService(db.Model):
    __tablename__ = "zzh_order_service"
    ...
    def __init__(self, order_no, item_id, service_name, policy_source, service_price, service_starttime,
                 service_deadline, direction_name, service_content, sheet_content, material_list, forecast_path,
                 service_contact_person, service_contact_phone, is_secular, is_evaluate, declare_list, create_time,
                 category_type, servcice_process):
        '''Constructor'''
...
clinetHead = ['id', 'orderNo', 'itemId', 'serviceName', 'policySource', 'servicePrice', 'serviceStarttime',
              'serviceDeadline', 'directionName', 'serviceContent', 'sheetContent', 'materialList', 'forecastPath',
              'serviceContactPerson', 'serviceContactPhone', 'isSecular', 'isEvaluate', 'declareList', 'createTime',
              'categoryType', 'servciceProcess']
OrderServiceChangeDic = {
    "id": "id",
    "orderNo": "order_no",
    "itemId": "item_id",
